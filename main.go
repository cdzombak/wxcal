...
func main() {
	...
	var timezone = flag.String("timezone", "", "IANA timezone name for sunrise/sunset calculations (eg. \"America/Detroit\"); if omitted, the timezone is determined from the given lat/lon")
